...
export default function Home() {
  const FORM_ENDPOINT = "https://formspree.io/f/xldowwje"; // Formspree endpoint
...
/* ✅ Contact Form Component (Formspree Integrated) */
function ContactForm({ endpoint }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow">
      ...
      {status === "success" && (
        <p className="mt-3 text-green-600 text-sm">✅ Message sent successfully!</p>
      )}
      {status === "error" && (
