      ...
      <header className="max-w-6xl mx-auto px-6 py-8 flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">Expert financial strategy & advisory</p>
          </div>
        </div>
      ...
      <main>
        <section className="max-w-6xl mx-auto px-6 py-16 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <p className="text-sm uppercase text-macrocGreen font-medium">Financial Consultancy</p>
            <h2 className="mt-4 text-4xl md:text-5xl font-extrabold leading-tight">
              Expertise forged with <span className="text-macrocGreen">fiercy</span> precision
            </h2>
            <p className="mt-6 text-lg text-slate-600">
              At Macroc Consultants we blend rigorous analysis with smart strategy to help individuals and businesses grow, protect, and optimise their wealth.
            </p>

            <div className="mt-8 flex gap-4">
              <a href="#contact" className="inline-block px-6 py-3 bg-macrocGreen text-white rounded-lg shadow hover:shadow-lg">Get a Consultation</a>
              <a href="#services" className="inline-block px-6 py-3 border border-slate-200 rounded-lg text-slate-700">Our Services</a>
            </div>
          ...
          <div className="flex-1">
            <div className="w-full h-72 md:h-80 rounded-2xl bg-gradient-to-br from-macrocGreen to-indigo-600 shadow-xl flex items-center justify-center text-white">
              <div className="p-6 max-w-xs text-center animate-pulse">
                ...
                <p className="mt-3 text-sm">Data-driven decisions. Tailored strategies.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section id="services" className="max-w-6xl mx-auto px-6 py-12">
          ...
          <p className="mt-2 text-slate-600">Comprehensive services designed for clarity and growth.</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="mt-4 text-slate-600">
                We combine industry expertise, robust analytics, and a client-first approach to deliver financial strategies that are practical, compliant, and growth-focused.
              </p>
            ...
            <div>
              <div className="w-full h-64 rounded-xl border border-slate-100 bg-white shadow flex items-center justify-center">
                <div className="p-6 text-center">
                  ...
                  <p className="mt-2 text-sm text-slate-600">Research → Strategy → Execution → Review</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="contact" className="max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="mt-6 grid md:grid-cols-2 gap-8">
            <form className="bg-white p-6 rounded-lg shadow" method="POST" action={FORM_ENDPOINT="https://formspree.io/f/your-form-id";}>
              ...
              <input name="email" required type="email" className="mt-1 w-full border border-slate-200 rounded px-3 py-2" placeholder="you@example.com" />

              <label className="block text-sm font-medium text-slate-700 mt-4">Message</label>
              <textarea name="message" required className="mt-1 w-full border border-slate-200 rounded px-3 py-2" rows={4} placeholder="How can we help?" />
            ...
            <div className="p-6 rounded-lg bg-gradient-to-br from-gray-50 to-white border border-slate-100">
              ...
              <p className="mt-2 text-slate-600">Email: <a className="text-macrocGreen" href="mailto:info@macroc.in">info@macroc.in</a></p>
              <p className="mt-2 text-slate-600">Phone: 6300447014, 9035437253</p>
              <p className="mt-2 text-slate-600">Address: Sri Pathi Rao Street, Oldpet, Palamaner, 517408</p>
