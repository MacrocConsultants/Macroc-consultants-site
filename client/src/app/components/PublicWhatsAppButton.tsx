...
export default function PublicWhatsAppButton({
  ...
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 flex min-h-[52px] items-center gap-2 rounded-full bg-[#25D366]/90 px-3 py-2 text-sm font-semibold text-white shadow-2xl shadow-black/30 backdrop-blur-sm transition hover:scale-105 hover:bg-[#1fbd59]/95 md:bottom-6 md:right-6 md:min-h-[64px] md:gap-3 md:px-4 md:py-3"
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white text-[#25D366] shadow-md md:h-11 md:w-11">
