...
export default function PublicCallButton({
  ...
  return (
    <a
      ...
      className="fixed bottom-20 right-4 z-50 flex min-h-[52px] items-center gap-2 rounded-full border border-[#fcd34d]/40 bg-[#0f172a]/88 px-3 py-2 text-sm font-semibold text-[#fcd34d] shadow-2xl shadow-black/30 backdrop-blur-sm transition hover:scale-105 hover:bg-[#1e293b]/92 md:bottom-24 md:right-6 md:min-h-[64px] md:gap-3 md:px-4 md:py-3"
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[#fcd34d] text-[#0f172a] shadow-md md:h-11 md:w-11">
