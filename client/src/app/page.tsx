...
export default async function Home({ searchParams }: HomePageProps) {
  ...
  const requestedService = resolvedSearchParams?.service?.trim() || "";
  ...
  return (
    <div className={`public-site public-font-${selectedFontStyle} min-h-screen w-full bg-slate-950 text-white`}>
      <div className="page-enter">
          ...
          <section id="about" className="w-full border-t border-slate-800 px-4 py-16 md:px-8">
            <div className="grid items-center gap-10 md:grid-cols-2">
              ...
              <ScrollReveal
                variant="right"
                delay={120}
                className="rounded-xl border border-slate-700 bg-gradient-to-tr from-slate-800 to-slate-900 p-6 text-center shadow-lg"
              >
        ...
        <ScrollReveal
          as="footer"
          className="w-full border-t border-slate-800 px-4 py-8 text-center text-sm text-gray-400 md:px-8"
        >
